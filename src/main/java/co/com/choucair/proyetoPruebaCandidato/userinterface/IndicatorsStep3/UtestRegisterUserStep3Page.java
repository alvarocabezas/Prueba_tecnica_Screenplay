...
public class UtestRegisterUserStep3Page extends PageObject {
    ...
    //Elemento para selecionar el computador
    ...
    public static final Target TEXT_YOUR_COMPUTER = Target.the("Ingresar el nombre del sistema operativo del computador").located(By.xpath("//*[@id=\"web-device\"]/div[1]/div[2]/div/input[1]"));

    //Elemento para selcionar la version del computador
    ...
    public static final Target TEXT_VERSION_COMPUTER = Target.the("Ingresar el nombre del la verion del cpmputador").located(By.xpath("//*[@id=\"web-device\"]/div[2]/div[2]/div/input[1]"));

    //Elemento para selecionar el idioma del computador
    ...
    //Elemento para ingresar nombre del idioma del computador
    ...
    //Boton para ingresar a la cuarta seccion del registro
