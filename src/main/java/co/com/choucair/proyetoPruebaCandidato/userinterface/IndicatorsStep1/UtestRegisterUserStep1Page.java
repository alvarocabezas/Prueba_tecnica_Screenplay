...
public class UtestRegisterUserStep1Page extends PageObject {
    ...
    public static final Target BUTTON_SECOND_SECTION_REGISTER = Target.the("Ingreso a la segundo parte del regsitro").located(By.xpath("//*[@id=\"regs_container\"]/div/div[2]/div/div[2]/div/form/div[2]/a"));
