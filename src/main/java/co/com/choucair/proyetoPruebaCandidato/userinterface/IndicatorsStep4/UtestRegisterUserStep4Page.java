...
public class UtestRegisterUserStep4Page extends PageObject {
    ...
    //Elemento para ingresar la confirmacion de la contraseña
    public static final Target INSERT_CONFIRMATION_PASSWORD = Target.the("Ingreso de la confirmacion de la contraseña").located(By.id("confirmPassword"));
