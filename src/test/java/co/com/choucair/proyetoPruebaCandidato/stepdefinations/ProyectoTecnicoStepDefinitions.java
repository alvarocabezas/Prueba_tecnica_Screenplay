...
import co.com.choucair.proyetoPruebaCandidato.questions.Answer_check_record;
...
public class ProyectoTecnicoStepDefinitions {
    ...
    public void verifyThatTheRegistrationIsComplete(List<DataRegistro>dataRegistro) {
        //verifiacion del registro
        OnStage.theActorInTheSpotlight().should(GivenWhenThen.seeThat(Answer_check_record.toThe(dataRegistro.get(0).getVerified_record())));
    }
